...
@interface PUPhotoLoadingView (){
    UILabel             *_failureLabel;
    PUPhotoProgressView *_progressView;
}

@end

@implementation PUPhotoLoadingView
...
- (void)showLoading
{
    ...
    if (_progressView == nil) {
        _progressView = [[PUPhotoProgressView alloc] init];
